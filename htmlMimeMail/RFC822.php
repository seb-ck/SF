 ...
 * $structure = Mail_RFC822::create()->parseAddressList($address_string, 'example.com', TRUE)
 * print_r($structure);
 *
...
class Mail_RFC822
{
	 ...
	 * @return Mail_RFC822
	 */
	public static function create($address = null, $default_domain = null, $nest_groups = null, $validate = null, $limit = null)
	{
		return new Mail_RFC822($address, $default_domain, $nest_groups, $validate, $limit);
	}
