...
try 
{
  ...
  $mylogin = $mySforceConnection->login($USERNAME, $PASSWORD);
	...
	$query = "SELECT Id FROM Case WHERE TYPE='Technical Support' AND Bu__c = '' AND AccountId = '0012400000AA0TT' AND Status='Closed' ORDER BY CREATEDDATE DESC LIMIT 100";
	$query = "SELECT Id FROM Case WHERE TYPE='Technical Support' AND Bu__c = '' AND Status='Closed' ORDER BY CREATEDDATE DESC LIMIT 100";
	$response = $mySforceConnection->query($query);
	$parentIds = '';
	$casesIds = array();
	$cases = array();
